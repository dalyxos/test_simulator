...
# This script will read data from a local file instead of the serial connected to the digital meter P1 port
...
def checkcrc(p1telegram):
    ...
    #print(f"checkcrc -> p1telegram:{p1telegram}")
...
def main():
    with open(file_path, 'r') as file:
        ...
        for p1line in file:
            ...
            p1telegram.extend(p1line.encode('ascii'))
